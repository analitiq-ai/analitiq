...
Conduct some, and or all of the following general observations on the presented information
, but try not stating the obvious:
- Write a short summary of the data presented
- Note anomalies or outliers evident in the data
- If you are presented time series data, note if there are any missing values
, such as gaps in dates or datetimes
