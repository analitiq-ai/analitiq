"""Class will split a yaml structure in a given format.
...
class YAMLMetaDataSplitter(RecursiveCharacterTextSplitter):
    """A Recursive Data StructureSplitter for YAML Files."""
