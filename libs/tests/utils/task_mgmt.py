...
class TestCombineTasksPairwise(unittest.TestCase):
    ...
    def test_combine_tasks_pairwise(self):
        ...
        # Expected result
        expected = {
            'Task1': {'Name': 'Query data', 'Using': 'SQL', 'Description': 'Query sales database. Aggregate sales data. Sort sales data'}
        }
    ...
    def test_do_combine_only_consecutive_tools(self):
        ...
        def side_effect(user_prompt, task1, task2):
            if task1['Using'] == task2['Using']:
                if (task1 is tasks['Task1'] and task2 is tasks['Task2']) or (task1 is tasks['Task4'] and task2 is tasks['Task5']):
        ...
        expected = {
            'Task1': {'Name': 'Query data', 'Using': 'SQL', 'Description': 'Query sales database. Aggregate sales data'},
            'Task3': {'Name': 'Visualize data', 'Using': 'DataViz', 'Description': 'Visualize the data'},
            'Task4': {'Name': 'Query data', 'Using': 'SQL', 'Description': 'Query sales database. Aggregate sales data'}
        }
