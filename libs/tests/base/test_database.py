...
class TestDatabaseWrapper(unittest.TestCase):
    ...
    def test_get_schema_names(self):
        ...
        inspector_mock.get_schema_names.return_value = [ 'information_schema',"public", "schema1"]
        ...
        self.assertEqual(schema_names, [ 'information_schema',"public", "schema1"])
    ...
    def test_get_schemas_and_tables(self):
        ...
        inspector_mock = MagicMock()
        inspector_mock.get_schema_names.return_value = [ 'information_schema', "schema1"]
        ...
        # Calling the method to test
        schemas_and_tables = self.database_wrapper.get_schemas_and_tables([  "schema1" ])
